...
/// for more details.
class FirstapiSink extends RequestSink {
  ...
  FirstapiSink(ApplicationConfiguration appConfig) : super(appConfig) {
  ...
  void setupRouter(Router router) {
    ...
    router.route("/").listen((request) async {
      return new Response.ok({"message": "Welcome to Dart First Rest Api"});
    });
  }
